...
fun UploadFamilyStudioCamera(
    ...
    BBiBBiSurface(
        ...
        Column(
            ...
            UploadFamilyStudioTopBar(
                onDispose = onDispose,
            )
            Spacer(modifier = Modifier.height(48.dp))
            UploadFamilyStudioPreviewBox(
            ...
            UploadFamilyStudioCameraBar(
                ...
                onClickCapture = {
                    if (isCapturing) return@UploadFamilyStudioCameraBar
